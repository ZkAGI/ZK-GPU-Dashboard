...
//   const connectedNodes = clustrData.filter(node => node.status === 'connected' || node.status === 'disconnected');
//   console.log('clustrData',clustrData)
...
//           <div>
//             <div className="text-3xl text-[#05997C]">
//               125<span className="text-xs text-[#A0AEC0]"> xp</span>
//             </div>
